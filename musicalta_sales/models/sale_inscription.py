    ...
    def _compute_invoice_amount(self):
        for record in self:
            record.invoices_amount_residual = sum(
                invoice.amount_residual for invoice in record.invoice_ids) if record.invoice_ids else record.sale_order_id.amount_residual if record.sale_order_id else False
